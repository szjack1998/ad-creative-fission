...
BASE = _resolve_base()
OUT = os.path.join(BASE, 'xincheng_real_fission_v2_report.html')
...
FMT = {
    '40632415704':'户外真人+证书展示','41754594941':'户外真人+证书展示',
    '41379732140':'纯图文信息卡','42117789987':'纯图文信息卡',
    '39158668835':'白底口播+动态大字报','39150194052':'科技风开场→白底口播',
    '38962770012':'白底口播+字卡','38986614588':'白底口播+字卡',
    '39158727095':'白底口播+字卡','39158778319':'白底口播+字卡',
    '39158811093':'白底口播','39290259529':'快剪/高动态','39290378461':'白底+多场景',
    '40458376438':'白底口播','39773921823':'白底口播','39774043280':'高动态快剪',
    '40457882068':'多场景混剪','39314358212':'场景对比混剪','37818264151':'居家/办公场景口播',
}
...
V = [
 ...
 dict(id='A1', pri='P0', cert='健康管理师', fmt='纯图文信息卡', mother='41379732140 (CVR王4.24%)',
      hook='时间窗口+低门槛',
      ...
      hyp='复用CVR王格式(4.11%均)+利益清单结构，验证「绿底vs米黄底」配色是否影响转化'),
 dict(id='A2', pri='P0', cert='AI应用工程师', fmt='纯图文信息卡', mother='42117789987 (米黄版)',
      hook='时间窗口+低门槛',
 ...
 dict(id='A3', pri='P1', cert='健康管理师', fmt='纯图文信息卡', mother='41379732140',
      hook='稀缺+社会认同',
 ...
 dict(id='B1', pri='P0', cert='健康管理师', fmt='户外真人+证书展示', mother='40632415704 (花费王/转化王)',
      hook='权威背书+含金量',
      ...
      hyp='1:1复刻花费王结构(转化866)，测试不同讲师/户外场景是否影响信任度'),
 dict(id='B2', pri='P0', cert='AI应用工程师', fmt='户外真人+证书展示', mother='40632415704(结构迁移)',
      hook='趋势驱动+消除门槛',
 ...
 dict(id='B3', pri='P1', cert='健康管理师', fmt='户外真人+证书展示', mother='40632415704',
      hook='痛点切入+简单直接',
 ...
 dict(id='C1', pri='P1', cert='健康管理师', fmt='多场景混剪', mother='40457882068',
      hook='行为中断+利益清单',
 ...
 dict(id='C2', pri='P1', cert='AI应用工程师', fmt='场景对比混剪', mother='39314358212 (CVR4.71%)',
      hook='消除门槛+硬利益',
      ...
      hyp='复用场景切换「疑虑回应」手法(CVR4.71%)，验证对AI工程师品类同样有效'),

 # ===== Family D 白底口播+动态大字报（走量，CTR王家族） =====
 dict(id='D1', pri='P1', cert='AI应用工程师', fmt='白底口播+动态大字报', mother='39158668835 (CTR3.25%)',
      hook='稀缺性+FOMO',
      ...
      hyp='保留CTR王钩子结构，测试「直播间CTA前置」是否补CVR短板(现1.74%)'),
 dict(id='D2', pri='P1', cert='健康管理师', fmt='白底口播+字卡', mother='40457882068(结构)',
      hook='行为中断+利益清单',
 ...
 dict(id='D3', pri='P2', cert='AI应用工程师', fmt='白底口播+字卡', mother='39158668835(变体)',
      hook='稀缺+社会认同',
 ...
 dict(id='E1', pri='P2', cert='AI应用工程师', fmt='科技风开场→白底口播', mother='39150194052 (CTR王6%)',
      hook='趋势驱动+消除门槛',
      ...
      hyp='【仅用于曝光/认知层】CTR达6%但CVR仅0.43%，不作为转化素材，测试暗场开场对低频人群的吸引力'),
]
...
html = f'''<!DOCTYPE html>
<html lang="zh-CN">
<head><meta charset="UTF-8"><title>新程教育 · 真实数据版裂变 v2（制片级）</title>
<style>
...
<body>
<div class="header"><h1>🧬 新程教育 · 真实数据版裂变 v2（制片级）</h1>
...
<div class="legend">💡 <b>双口径结论</b>：① <b>CPA（单转化成本，越低越好）</b>最低的是 <b>白底系列</b>(¥199~206) 与 <b>多场景混剪</b>(¥203)——制作便宜+流量划算，是走量主力；
② <b>CVR（转化率，越高越好）</b>最高的是 <b>纯图文信息卡</b>(4.11%) 与 <b>户外真人+证书展示</b>(4.06%)——信任/offer更强。<br>
<b>分配逻辑</b>：P0 押在「高CVR且当前素材量少、可降依赖」的 <b>纯图文信息卡</b> 与 <b>户外真人</b>（账户目前7成以上是白底口播，需多元化）；白底系列按CPA优势作P1走量；<b>科技风开场</b>(CTR6%但CVR0.43%) 仅作认知层(E1)。</div>
</div>
